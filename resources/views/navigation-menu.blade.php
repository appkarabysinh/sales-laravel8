        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <x-nav-dropdown title="Apps" align="right" width="48">
                        ...
                        @endcan
                        @can('view-any', App\Models\OrderDetail::class)
                        <x-dropdown-link href="{{ route('order-details.index') }}">
                        Order Details
                        </x-dropdown-link>
                        @endcan
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            <x-jet-responsive-nav-link href="{{ route('dashboard') }}" :active="request()->routeIs('dashboard')">
                ...
                @endcan
                @can('view-any', App\Models\OrderDetail::class)
                <x-jet-responsive-nav-link href="{{ route('order-details.index') }}">
                Order Details
                </x-jet-responsive-nav-link>
                @endcan
                @can('view-any', App\Models\Payment::class)
                ...
                @endcan
                @can('view-any', App\Models\Stock::class)
                <x-jet-responsive-nav-link href="{{ route('stocks.index') }}">
                Stocks
                </x-jet-responsive-nav-link>
                @endcan
                @can('view-any', App\Models\Card::class)
                <x-jet-responsive-nav-link href="{{ route('cards.index') }}">
                Cards
                </x-jet-responsive-nav-link>
                @endcan
